...
fig, (ax0, ax1, ax2, ax3, ax4, ax5, ax6) = plt.subplots(nrows=1, ncols=7, figsize=(16, 6), sharex=True, sharey=True)
...
'''
there is probably a nice way to automate this somewhere

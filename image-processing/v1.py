...
class linefinder:
    ...
    def blur_sample_gauss(self, view_plot):
        ...
        '''
        sample_blur = ndimage.gaussian_filter(original, sigma=sigma)
        ...
        if view_plot == True:
            ...
            ax[0][1].set(xlabel='', ylabel='', title = 'Blurred Version, sigma ={}'.format(sigma))

            ax[1][0].plot(np.arange(0,np.size(original[200]) ,1), original[200])
    ...
    def find_lines_gblur(self, view_plot):
        ...
        '''
        x = blur_sample_gauss(original, sigma, False)
        ...
        if view_plot == True:
            ...
            ax[0].set(xlabel='', ylabel='', title = 'Blurred Sample, sigma = {}'.format(sigma))
    ...
    def FT_blur(self, view_plot=True):
        ...
        '''
        x = blur_sample_gauss(original, sigma, view_plot=False)
    ...
    def find_lines_fourier(self, view_plot=True):
        ...
        '''
        x = blur_sample_gauss(original,sigma, False)
        y = FT_blur(original,sigma, False)
